...
function setupMobileMenu() {
  ...
  // Click away to close - listen on the overlay
  mobileSidebar?.addEventListener("click", (e) => {
    // Only close if clicking on the overlay background, not the sidebar content
    if (e.target === mobileSidebar) {
      closeMobileSidebar()
    }
  })

  // Prevent clicks inside sidebar content from bubbling up
